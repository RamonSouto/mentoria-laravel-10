                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('atualizar.cliente', $cliente->id) }}" class="btn btn-sm btn-light">Editar</a>
                                <meta name="csrf_token" content="{{ csrf_token() }}">
                                <a onclick="deleteRegistroPaginacao('{{ route('cliente.delete') }}', {{ $cliente->id}} )" class="btn btn-sm btn-danger">Excluir</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
